...
| 文档版本 | V1.0 |
| 编写日期 | 2026-08-01 |
| 依据文档 | 《投资测算系统 软件产品开发需求书.md》V1.0（2026-07-24，下称 **PRD**） |
| UI 基准 | 《投资测算系统-原型.html》（2026-08-01 生成，单文件高保真原型，下称 **原型**） |
...
| 内容 | 路径 |
| --- | --- |
| PRD 需求书 | `投资测算系统 软件产品开发需求书.md` |
| UI 高保真原型 | `投资测算系统-原型.html`（浏览器直接打开，需联网加载 ECharts CDN） |
